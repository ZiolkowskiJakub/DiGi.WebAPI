...
**DiGi.WebAPI** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.WebAPI](DiGi.WebAPI)** (Path: `DiGi.WebAPI\DiGi.WebAPI`)
